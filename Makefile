all: readjpeg readImage blobDir boxCreDel frameSub copyFrame writeImage stack
...
clean:
	rm readjpeg readImageTest blobDirTest boxCreateDelete frameSubTest copyFrame writeImageTest stackTest
